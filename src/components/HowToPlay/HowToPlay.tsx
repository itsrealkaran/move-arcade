...
import IllustrationGameOver  from "../../images/illustration_game-over.svg";
import IllustrationTapToStack from "../../images/illustration_tap-to-stack.svg";
...
function HowToPlayModal({
  ...
  return (
    <ModalDefault setIsOpened={setIsOpened}>
      ...
      <HowToPlayFigure
        Illustration={IllustrationTapToStack as React.ElementType}
      ...
      />
      <HowToPlayFigure
        Illustration={IllustrationGameOver as React.ElementType}
        text={
          <>
            too early / too late
            <br /> = game over
